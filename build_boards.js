    ...
    <header class="top-nav">
        <div class="container top-nav-inner flex-between">
            <a class="logo-area" href="../../index.html">
                <img src="../../assets/images/site-logo.png" alt="?숆탳 濡쒓퀬" class="main-logo-image">
                <div class="logo-text">
                    <h1>珥앺쉶?좏븰?곌뎄??/h1>
                    <span>??쒖삁?섍탳?λ줈???쒖쁺) 吏곸쁺 ?좏븰?곌뎄??/span>
                </div>
            </a>
            <div class="top-links-area">
                <nav class="top-links">
                    <a href="../../index.html">Home</a>
                    <a href="../../sitemap.html">?ъ씠?몃㏊</a>
                    <span class="lang-selector">ENG</span>
                </nav>
                <div class="search-wrap">
                    <input type="text" placeholder="寃?됱뼱瑜??낅젰?섏꽭??>
                    <button type="button" aria-label="寃??>
        ...
        <div class="container nav-icons-wrap">
            ...
            <a href="../../campus_life.html" class="nav-icon-link"><div class="icon-box"><i class="ph-light ph-users"></i></div><span>학생안내</span></a>
    ...
    <footer class="modern-footer">
        <div class="container">
            <div class="footer-grid">
                <div class="f-col">
                    <h6>OUR CAMPUS</h6>
                    <h3 class="f-brand">珥앺쉶?좏븰?곌뎄??/h3>
                    <p>??쒖삁?섍탳?λ줈???쒖쁺)<br>吏곸쁺 ?좏븰?곌뎄??/p>
                ...
                <div class="f-col f-links">
                    <h6>QUICK LINKS</h6>
                    <ul>
                        <li><a href="../../intro_greeting.html">?숆탳?뚭컻 <i class="ph-light ph-arrow-right"></i></a></li>
                        <li><a href="../../admissions_guideline.html">?낇븰?덈궡 <i class="ph-light ph-arrow-right"></i></a></li>
                        <li><a href="../../degree_bachelor.html">?숈쐞怨쇱젙 <i class="ph-light ph-arrow-right"></i></a></li>
                        <li><a href="../../online_service.html">?⑤씪?몄꽌鍮꾩뒪 <i class="ph-light ph-arrow-right"></i></a></li>
                        <li><a href="../../campus_life.html">??숈깮??<i class="ph-light ph-arrow-right"></i></a></li>
                    </ul>
                </div>
                <div class="f-col f-connect">
                    <h6>CONNECT</h6>
                    <p>媛쒗쁺二쇱쓽 ?좏븰???좊? ?꾩뿉 援먰쉶? ?멸퀎瑜??ш린??紐⑺쉶?먯? 吏?꾩옄瑜??몄슦???좏븰 怨듬룞泥댁엯?덈떎.</p>
                    <a href="../../admissions_guideline.html" class="btn-primary">?낇븰 ?덈궡 ?뺤씤?섍린</a>
                </div>
            </div>
            <div class="footer-bottom">
                <p>&copy; 2026 ??쒖삁?섍탳?λ줈???쒖쁺) 珥앺쉶?좏븰?곌뎄?? All rights reserved.</p>
            </div>
        </div>
    </footer>
    ${extraScript}
...
for (const [boardId, boardConfig] of Object.entries(boards)) {
    ...
    const posts = markdownFiles.map((fileName) => {
        ...
        const articleHtml = `
            <a href="../../${boardConfig.page}" class="board-back-link"><i class="ph-light ph-arrow-left"></i> ${boardConfig.title} 寃뚯떆?먯쑝濡??뚯븘媛湲?/a>
